function animateBall() {
    anime({
        ...
        keyframes: [
            ...
            {translateY: 265, translateX: 320, duration: 200},
            {duration: 1800}, // TIME: 21,300
...
function animateSmallTriangle() {
    anime({
        ...
        keyframes: [
            ...
            {duration: 150}, 
            {translateX: 320, duration: 100}, // rebound from attack // TIME: 19,950 MS
            ...
            {translateY: 690, translateX: 320, duration: 900}, // TIME: 36,350
            {duration: 1500}, // 37,850
            {translateY: 550, duration: 1800}, // moving up toward door // TIME: 39,650
            {translateY: 350, translateX: 290, duration: 2000}, // TIME: 41,650
            {translateY: 315, translateX: 300, duration: 500}, // TIME: 42,150
            {duration: 2500}, // 44,650
            {translateX: 240, duration: 500},
            {duration: 400}, // 45,550
...
function rotateSmallTriangle() {
    anime({
        ...
        keyframes: [
            ...
            {duration: 500},
            {rotateZ: 0, duration: 300}, // triangle is at the 'door' of the rectangle
            {duration: 500},
            {duration: 500},
...
function rotateBigTriangle() {
    anime({
        ...
        keyframes: [
            ...
            {duration: 200},
            {duration: 100},
            {rotateZ: 80, duration: 400}, // opening the door again // #4
            {duration: 800}, // going through door more
...
function animateLowerDoor() {
    anime({
        targets: '.door-lower',
        keyframes: [
            {duration: 64500},
            {rotateZ: 70, translateX: 40, translateY: -20, duration: 50},
        ],
        easing: 'linear',
    });
}

function animateUpperDoor() {
    anime({
        targets: '.door-upper',
        keyframes: [
            {duration: 64500},
            {rotateZ: 90, translateX: -30, translateY: -20, duration: 50},
            {duration: 1100},
            {rotateZ: 80, translateX: -50, translateY: 150, duration: 50},
        ],
        easing: 'linear',
    });
}

function animateLeftWall() {
    anime({
        targets: '.top-left-wall',
        keyframes: [
            {duration: 65300},
            {rotateZ: -30, translateX: 0, translateY: -50, duration: 50},
            {duration: 800},
            {rotateZ: -30, translateX: 0, translateY: -120, duration: 50},
        ],
        easing: 'linear',
    });
}

function animateRightWall() {
    anime({
        targets: '.top-right-wall',
        keyframes: [
            {duration: 65300},
            {rotateZ: 20, translateX: 0, translateY: -20, duration: 50},
            {duration: 1000},
            {rotateZ: 20, translateX: 0, translateY: -120, duration: 50},
        ],
        easing: 'linear',
    });
}
